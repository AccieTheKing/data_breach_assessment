   ...
   return (
      <div>
         ...
         <div className="sidebar" id="side" onClick={activeClass}>
            ...
            <a href="#dc">&nbsp;• Draft or calculate score?</a>
            <a href="#step7">Step 7</a>
            <a href="#sl">&nbsp;• Results: SL and actions</a> <br></br>
         </div>

         <div className="content" style={{left: "400px"}}>
            ...
            the first person in your organization became aware of the data breach. The date determines 
            ...
            list is not exhaustive; however, most data involved in real cases can be matched to at least one of 
            the categories. Credentials are not considered a specific category of data and should be handled 
            based on the type of data processed by the systems they provide access to.
            <br></br>
            <br></br>
            ...
            controllers or the individuals, invalidity/inaccuracy of data, public availability (before the breach), 
            nature of data etc. 
            <br></br> <br></br> 
            Insert picture
            <br></br> <br></br> 
            ...
            <br></br>
            <h2 id="behaviouralData">Behavioral data</h2>
            ...
            <p>This part of the assessment evaluates how easy it is to identify an individual based on the 
            ...
            <li>Negligible is when it is extremely difficult to match the data to a particular person, but under 
            certain conditions it could be possible.<br></br></li>
            <li>Maximum is selected when identification is possible directly from the data breached with no special 
            research needed to discover the individual’s identity</li>
            <br></br>
            Identification may be directly (e.g. on the basis of a given name) or indirectly (eg. on the basis of 
            ID number) possible from the breached data, but may also depend on the specific context of the breach. 
         ...
         <h1 id="step4" className="h1Style">
            ...
            <p>The elements considered under CBa are loss of security (confidentiality, integrity, availability), 
               malicious intent and the size of the breach and are complementary to DPC and EI. Unlike DPC and EI 
               where the maximum score reached is selected, the points obtained for each CBa item are added, as 
               different circumstances may occur in the same breach. 
               <br></br> <br></br>
               <li>Loss of confidentiality occurs when the information is accessed by parties who are not authorized or 
               do not have a legitimate purpose to access it. </li>
              
               <li>Loss of integrity occurs when the original data has been altered by unauthorized parties or systems. 
            </li>
            <li>Loss of availability occurs when the original data cannot be accessed when needed. It can be either 
            temporal (data can be recovered, but it will take time), or permanent (data can not be recovered). 
            </li><br></br>
            Malicious intent examines whether the breach was due to an error or mistake, either human or technical, 
            or it was caused by an intentional action of malicious intent. Non malicious breaches include cases of 
            accidental loss, inadequate disposal, human error and software bug or misconfiguration. Malicious breaches 
            include cases of theft and/or hacking that aim to either harm individuals or the data controller by disclosing 
            the personal data to third parties or selling the personal data for financial gain.
            <br></br><br></br>
         ...
         <h1 id="step5" className="h1Style">
            ...
            <p>The elements assessed under CBm are the specific circumstances of the breach and are custom made for 
               NN Non-Life. These are complementary to DPC, EI, and CBa. The points obtained for each CBm element 
               are subtracted to achieve the final score, as different extenuating circumstances may occur in the same breach.
               <br></br> <br></br>
         </p>
         ...
         <h1 id="step6" className="h1Style">
            ...
            <p>When all fields have been answered the “Calculate Score”-button will be enabled. If there is 
         ...
         <h1 id="step7" className="h1Style">
            ...
            <p>When pushing the “Calculate Score”-button the result is revealed with a score between 0 and 4 that 
               defines the Severity Level. The Severity Level goes from “Insignificant” to “Critical”. The risk 
               level refers to how the data breach affects the rights and freedoms of the affected individuals.
               The score can be less than 0 if there have been specific mitigating circumstances. 
               ...
               <li>Document any personal data breaches, comprising the facts relating to the personal data breach, its effects and the remedial action taken.</li>
               <li>Notify the personal data breach to the supervisory authority within 72 hours from awareness date unless the data breach is unlikely to result in a risk to the rights and freedoms.</li>
               <li>Communicate the personal data breach to the data subjects without undue delay if the breach is likely to result in a high risk to their rights and freedoms.</li>
               <br></br> 
